//! Separator table for the default tokenizer: every `\p{Z}` or `\p{P}` code
//! point, as classified by the JavaScript engine (V8/ICU) MiniSearch runs in.
//! Generated by `scripts/gen-separators.mjs` with Node 24.21.0
//! (ICU 78.3, Unicode 17.0). Do not edit by hand.

/// Unicode version of the tables below.
pub const UNICODE_VERSION: &str = "17.0";

/// Separator flags for the ASCII range (the hot path).
#[rustfmt::skip]
static ASCII: [bool; 128] = [
...
/// Inclusive code point ranges, ascending and disjoint (201 ranges).
#[rustfmt::skip]
static RANGES: &[(u32, u32)] = &[
    (0x0020, 0x0023), (0x0025, 0x002A), (0x002C, 0x002F), (0x003A, 0x003B),
    (0x003F, 0x0040), (0x005B, 0x005D), (0x005F, 0x005F), (0x007B, 0x007B),
    (0x007D, 0x007D), (0x00A0, 0x00A1), (0x00A7, 0x00A7), (0x00AB, 0x00AB),
    ...
    (0x1360, 0x1368), (0x1400, 0x1400), (0x166E, 0x166E), (0x1680, 0x1680),
    (0x169B, 0x169C), (0x16EB, 0x16ED), (0x1735, 0x1736), (0x17D4, 0x17D6),
    (0x17D8, 0x17DA), (0x1800, 0x180A), (0x1944, 0x1945), (0x1A1E, 0x1A1F),
    (0x1AA0, 0x1AA6), (0x1AA8, 0x1AAD), (0x1B4E, 0x1B4F), (0x1B5A, 0x1B60),
    (0x1B7D, 0x1B7F), (0x1BFC, 0x1BFF), (0x1C3B, 0x1C3F), (0x1C7E, 0x1C7F),
    (0x1CC0, 0x1CC7), (0x1CD3, 0x1CD3), (0x2000, 0x200A), (0x2010, 0x2029),
    (0x202F, 0x2043), (0x2045, 0x2051), (0x2053, 0x205F), (0x207D, 0x207E),
    ...
    (0x2E00, 0x2E2E), (0x2E30, 0x2E4F), (0x2E52, 0x2E5D), (0x3000, 0x3003),
    ...
    (0x10D6E, 0x10D6E), (0x10EAD, 0x10EAD), (0x10ED0, 0x10ED0), (0x10F55, 0x10F59),
